...
})(this, function(__WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_66__) {
...
function parse(markup, mime, forceXMLDom) {
	...
	if (typeof DOMParser === "undefined" || forceXMLDom) {
		Parser = __webpack_require__(19).DOMParser;
	} else {
		Parser = DOMParser;
	}
...
var _mapping = __webpack_require__(9);

var _mapping2 = _interopRequireDefault(_mapping);

var _replacements = __webpack_require__(4);

var _marksPane = __webpack_require__(25);
...
var _annotations = __webpack_require__(27);
...
var _locations = __webpack_require__(32);
...
var _packaging = __webpack_require__(36);
...
var _pagelist = __webpack_require__(37);
...
var _request2 = __webpack_require__(12);
		...
		value: function checkRequirements() {
			try {
				if (typeof JSZip === "undefined") {
					var _JSZip = __webpack_require__(66);
					this.zip = new _JSZip();
				} else {
					this.zip = new JSZip();
				}
...
// Default Views
ePub.register.view("iframe", __webpack_require__(23));

// Default View Managers
ePub.register.manager("default", __webpack_require__(13));
ePub.register.manager("continuous", __webpack_require__(22));
  ...
  */
	...
	_createClass(Section, [{
		...
		value: function load(_request) {
			var request = _request || this.request || __webpack_require__(12);
			var loading = new _core.defer();
			var loaded = loading.promise;
		...
		value: function render(_request) {
			...
			this.load(_request).then(function (contents) {
				...
				if (typeof XMLSerializer === "undefined" || isIE) {
					Serializer = __webpack_require__(19).XMLSerializer;
				} else {
...
if(typeof __WEBPACK_EXTERNAL_MODULE_66__ === 'undefined') {var e = new Error("Cannot find module \"JSZip\""); e.code = 'MODULE_NOT_FOUND'; throw e;}
